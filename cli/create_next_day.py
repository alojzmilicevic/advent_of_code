...
def create_day_folder(year, day, auto_download=True):
    ...
    if auto_download and session:
        print("  Attempting to download input.txt...")
        if download_input(year, day, input_file):
            print("  ✓ Downloaded input.txt from adventofcode.com")
            downloaded = True
        else:
            print("  ✗ Could not download input (creating empty file)")
